...
void RoutePlanner::AddNeighbors(RouteModel::Node *current_node) {
    ...
    for(RouteModel::Node * neighbor_node : current_node->neighbors){
        //if(neighbor_node->visited == false){
            ...
            // g value of neighbor should be the parents g value + the distance between parent node and neighbor node
...
RouteModel::Node *RoutePlanner::NextNode() {
    std::sort(open_list.begin(), open_list.end(), Compare);
  	...
  	RouteModel::Node *node_next_p = open_list.front();
...
std::vector<RouteModel::Node> RoutePlanner::ConstructFinalPath(RouteModel::Node *current_node) {
    ...
    while (path_node->parent != nullptr)
    {
        ...
        path_found.insert(path_found.begin(), *path_node);
